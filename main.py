...
def pdufa_biotech_scanner():
    ...
    """
    # قائمة PDUFA المحدّثة يدوياً — أضف المواعيد الجديدة هنا
    # المصدر: BioPharma Catalyst، FDATracker.com (مواقع مجانية)
    PDUFA_CALENDAR = [
        # format: (SYMBOL, DRUG_NAME, PDUFA_DATE_STR, INDICATION)
    ...
    while True:
        try:
            ...
            for symbol, drug, pdufa_str, indication in PDUFA_CALENDAR:
                try:
