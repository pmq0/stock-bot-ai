...
CHUNK_SIZE = 100
FAST_FILTER_WORKERS = 5       # لا تزيد عن 5 لتجنب الحظر
DEEP_ANALYSIS_WORKERS = 3
DELAY_BETWEEN_REQUESTS = 0.5  # زيادة الـ delay لتجنب الحظر (كان 0.15)
BREAK_BETWEEN_CHUNKS = 5
TRADE_MONITOR_INTERVAL = 60
MAX_TICKERS_TO_SCAN = 3800    # 🔥 حد أقصى للأسهم المفحوصة
...
def process_symbol(symbol):
    try:
        ...
        score = explosion_score  # نبدأ بنقاط الانفجار
