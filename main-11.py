...
Ranking+AI، AUTO HUNTER المُثرى (سكور 80+)، Mega Mover (حركة كبيرة حتى لو هدت)، دوجي بعد هبوط (بتأكيد اليوم اللي بعده)، وأخبار Finnhub مرفقة تلقائيًا بأي تنبيه كبير
...
if __name__ == "__main__":
    ...
    logger.info('🚀 Mega Mover + ✨ Doji Reversal started')
